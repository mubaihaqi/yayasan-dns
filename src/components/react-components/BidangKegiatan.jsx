...
const BidangKegiatan = () => {
  ...
  return (
    <section className="pt-20 pb-16 bg-background relative overflow-hidden">
      {/* Decorative elements */}
      <div className="absolute top-0 left-0 w-full h-full bg-grid-texture opacity-5"></div>

      <div className="container mx-auto px-4 max-w-6xl relative z-10">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-5xl font-bold text-btn mb-6">
            Bidang Kegiatan
          </h2>
          <div className="w-32 h-1 bg-border mx-auto rounded-full mb-4"></div>
          <p className="text-txt/90 max-w-2xl mx-auto text-lg">
            ...
            >
              <div className="p-8 flex flex-col flex-grow">
                <div className="w-16 h-16 rounded-xl bg-btn/10 flex items-center justify-center mb-6 transition-all duration-300 group-hover:bg-btn/20">
                  <span className="text-btn font-bold text-2xl">
                    {divisi.id}
                  </span>
                </div>
                <h3 className="text-2xl font-bold text-btn mb-4">
                  {divisi.name}
                </h3>
                <p className="text-txt/80 mb-6 leading-relaxed flex-grow">
                  {divisi.description}
                </p>
