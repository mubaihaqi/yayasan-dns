...
export default function Navbar() {
  ...
  return (
    <div
      className={`navbar shadow-lg fixed z-50 px-4 md:px-6 lg:px-24 py-3 transition-all duration-500 ease-in-out ${
        scrollPosition > 50
    ...
    >
      ...
      <div className="navbar-center hidden lg:flex">
        ...
        >
          ...
          >
            <a href="/tentang-kami" className="px-4 py-2">Tentang Kami</a>
          </li>
          <li
          ...
          >
            <details className="group">
              <summary className="relative px-4 py-2 cursor-pointer list-none flex items-center">
                Lembaga Pendidikan
                <ChevronDown size={16} className="ml-1 transition-transform duration-300 group-open:rotate-180" />
              </summary>
              <ul
          ...
          >
            <a href="/laporan" className="px-4 py-2">Laporan</a>
          </li>
          <li
            className={`rounded-xl bg-transparent border-transparent shadow-none hover:shadow-md btn transition-all duration-300 transform hover:-translate-y-0.5 ${
              scrollPosition <= 50
          ...
          >
            <a href="/kontak" className="px-4 py-2">Kontak</a>
          </li>
        </ul>
      </div>
