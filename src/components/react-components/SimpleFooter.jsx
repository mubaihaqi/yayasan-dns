...
export default function SimpleFooter() {
  return (
    <footer className="bg-bghd text-cartu py-8 px-4">
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-4 md:mb-0">
            <h3 className="text-xl font-bold">Yayasan DNS</h3>
            <p className="text-cartu/80 text-sm mt-1">
              Membangun generasi berkualitas melalui pendidikan islami
            </p>
          </div>
          ...
          <div className="flex flex-col items-center md:items-end">
            ...
            <div className="text-cartu/60 text-sm">
              ...
              <p>Genteng, Banyuwangi, Jawa Timur</p>
            </div>
          </div>
        </div>
